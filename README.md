...
Licensed under the MIT License as stated in the [LICENSE](LICENSE) file.

Unless explicitly stated otherwise here, I don't take credit for any of the compiled mods (located in the `jar_files` directory) included in this repository, nor am I attempting to license them. All of the mods included here are subject to their owner's license terms, not mine. 
